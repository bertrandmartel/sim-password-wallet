...
import fr.bmartel.smartcard.passwordwallet.JavaCardTest;
...
public class TestUtils {
    ...
    private final static byte[] CMD_SET_PIN_CODE = new byte[]{(byte) 0x90, 0x24, 0x00, (byte) 0x80};

    public final static byte[] TEST_PIN_CODE = new byte[]{0x00, 0x00, 0x00, 0x00};
